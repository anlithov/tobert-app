...
const ImageMultiCorneredWithTitles: FC<Props> = ({
  imgWidth = '3.4em',
  imgHeight,
  title,
  titleSize = '1.6em',
...
export default ImageMultiCorneredWithTitles;
