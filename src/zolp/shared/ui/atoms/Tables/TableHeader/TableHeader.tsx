...
import { Container } from './TableHeader.styled.ts';
import TableHeaderCell from './base/TableHeaderCell/TableHeaderCell.tsx';
import { TableHeaderColumnProps } from './TableHeaderCell.types.ts';
import TableHeaderNumerationCell from './TableHeaderNumerationCell.tsx';
import { OrderDirection, TableOrderState } from '../Table/Table.types.ts';
